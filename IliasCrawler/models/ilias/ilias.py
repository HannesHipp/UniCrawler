from IliasCrawler.extractor.dynamic_attribute import DynamicAttribute
from IliasCrawler.extractor.locator import ContainsFilter, ExactFilter, Locator, get_attr
